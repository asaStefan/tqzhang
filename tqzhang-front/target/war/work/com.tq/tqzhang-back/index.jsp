						...
						<div class="col-md-3">
							...
							<div class="header-left clearfix">
								...
								<div class="site-slogan">
									<h4> åäº¬å½æ³°åçæååå±ä¸­å¿</h4>
								</div>
											...
											<div class="collapse navbar-collapse" id="navbar-collapse-1">
												...
												<li class="active"><a href="index.html">é¦é¡µ</a></li>
													<!-- <li class="dropdown active">
														<a href="index.html" class="dropdown-toggle" data-toggle="dropdown">é¦é¡µ</a>
					...
					<div class="slider-banner-container">
						<div class="slider-banner">
							<ul>
								...
								<!-- main image -->
								<img src="images/002.jpeg"  alt="slidebg1" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
								...
								<!-- main image -->
								<img src="images/003.jpeg"  alt="slidebg1" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
								...
								<!-- main image -->
								<img src="images/004.jpeg"  alt="kenburns"  data-bgposition="left center" data-kenburns="on" data-duration="10000" data-ease="Linear.easeNone" data-bgfit="100" data-bgfitend="115" data-bgpositionend="right center">
...
<!-- 							</div> -->
								...
								<div class="footer-content">
									...
									<nav>
										<ul class="nav nav-pills nav-stacked">
											<li><a href="http://www.moe.gov.cn/">ä¸­å½æè²é¨</a></li>
											<li class="active"><a href="http://www.mod.gov.cn/">ä¸­å½å½é²é¨</a></li>
											<li><a href="https://www.baidu.com">ä¸­å½ææºæ1</a></li>
										</ul>
									</nav>
								</div>
							</div>
								...
								<div class="footer-content">
									...
									<div class="gallery row">
										<div class="gallery-item col-xs-4">
											<div class="overlay-container">
												<a href="http://www.moe.gov.cn/">ä¸­å½æè²é¨</a>
											</div>
										</div>
										<div class="gallery-item col-xs-4">
											<div class="overlay-container">
										...
										<div class="gallery-item col-xs-4">
											<div class="overlay-container">
												<a href="page-about.html" class="link"><span>æ´å¤</span></a>
											</div>
										</div>
									</div>
								</div>
				...
				<div class="subfooter">
					<div class="container">
						<div class="row">
							<div class="col-md-6">
							<p><i class="fa fa-fax pr-10"></i> çµè¯ï¼+00 1234567890      é®ç®±ï¼<i class="fa fa-envelope-o pr-10"></i> info@idea.com</p>
								<p>Copyright &copy; 2017.Company name All rights reserved.<a target="_blank" href="http://www.baidu.com/">å¼ å¸;</a></p>
