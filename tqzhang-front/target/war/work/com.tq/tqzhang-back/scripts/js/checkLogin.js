            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    switch(JSON.stringify(data.code))
                    {
                        ...
                        case '"A09406"'://A00000
                            $.cookie('code',"A00000");//data.data.code);
                            $.cookie('token',"79faf82271944fe38c4f1d99be71bc9c");//data.data.token);
                            $.cookie("name","1312132221");//$('#mobile').val(), { expires: 1})
                        ...
                        case '"A00000"'://
                            ...
                            $.cookie('code',"A00000");//data.data.code);
                             $.cookie('token',"79faf82271944fe38c4f1d99be71bc9c");//data.data.token);
                             $.cookie("name","1312132121");//$('#mobile').val(), { expires: 1})
                             document.location.href ="./pages/index.html"
                             // alert("登录成功")
                             $('.alert-warning').css('display','none');
                             break;
